    ...
    return (
      <div className="proj-card">
        ...
        <div className="proj-desc">
          <div>
            <h1 className="font-bold font-32">Krona</h1>
            <p>
              Developed in GameMaker Studio 2 with their custom language (GML),
              I was responsible for the player's mechanics as well as enemy AI.
            </p>
          </div>
